...
static MemMapEntry sifive_e_memmap[] = {
    [SIFIVE_E_DEV_MRAM] =     {     0x0,     0x20000 },
    // [SIFIVE_E_DEV_DEBUG] =    {        0x0,     0x1000 },
    // [SIFIVE_E_DEV_MROM] =     {     0x1000,     0x2000 },
    [SIFIVE_E_DEV_OTP] =      {    0x20000,     0x2000 },
    [SIFIVE_E_DEV_CLINT] =    {  0x2000000,    0x10000 },
    [SIFIVE_E_DEV_MROM] =     {  0x2100000,     0x2000 },
    ...
    [SIFIVE_E_DEV_DTIM] =     { 0x80000000,     0x20000000}//0x4000 }
};
...
static void sifive_e_machine_init(MachineState *machine)
{
    ...
    memory_region_init_ram(shrd_mem, NULL, "riscv.sifive.e.mram",
                           memmap[SIFIVE_E_DEV_MRAM].size, &error_fatal);
    memory_region_add_subregion(sys_mem, memmap[SIFIVE_E_DEV_MRAM].base,
                                shrd_mem);
    ...
    rom_add_blob_fixed_as("mrom.reset", reset_vec, sizeof(reset_vec),
                          memmap[SIFIVE_E_DEV_MROM].base, &address_space_memory); //for csim
